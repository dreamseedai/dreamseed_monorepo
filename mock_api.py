...
SAMPLE = {
    434: {
        ...
        "que_status": 1,
        "que_createddate": "2020-01-01",
        "que_modifieddate": "2020-01-02",
    },
    435: {
        "id": 435,
        "que_id": 435,
        ...
        "que_en_resource": "CCO",
        "que_status": 1,
        "que_createddate": "2020-02-01",
        "que_modifieddate": "2020-03-01",
    },
    11384: {
        "id": 11384,
        "que_id": 11384,
        ...
        "question_en": (
            ...
            "hydrophilic and hydrophobic parts in the molecule. Identify the "
            "functional group (s) present in the molecule.<br /><img "
            'src="/images/editor/11384-31.png" alt="" />'
        ),
        "solution_en": (
            "Functional groups present in the molecule are:<br />(i) Ether, "
            "and<br />(ii) primary alcoholic group<br /><br />Non-ionic "
            "detergents are molecules that contain both hydrophobic and "
            "hydrophilic parts, which allows them to interact with both water "
            'and oil-based substances.<br /><img src="/images/editor/11384-32.png" '
            'alt="" />'
        ),
...
def list_questions(page: int = 1, page_size: int = 100, original_id: int | None = None) -> dict:
