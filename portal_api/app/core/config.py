...
class Settings(BaseSettings):
    ...
    stripe_portal_return_url: str | None = Field(
        default=None, alias="STRIPE_PORTAL_RETURN_URL"
    )
    # Cache
    ...
    export_rate_limit_per_min: int = Field(
        default=10, alias="EXPORT_RATE_LIMIT_PER_MIN"
    )
    # Admin
    admin_api_key: str | None = Field(default=None, alias="ADMIN_API_KEY")
    # CORS & Security Headers
    allowed_origins: str = Field(
        default="http://127.0.0.1:5172", alias="ALLOWED_ORIGINS"
    )
