...
class RAnalyticsClient:
    def __init__(self,
                 ...
                 auth_header: str = "X-Internal-Token") -> None:
    ...
    def _post(self, path: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        with httpx.Client(timeout=self.timeout) as client:
            r = client.post(f"{self.base_url}{path}",
    ...
    # 7.1 endpoints (spec)
    def score_topic_theta(self, student_id: str, topic_ids: List[str]) -> Dict[str, Any]:
        payload = {"student_id": student_id, "topic_ids": topic_ids}
        return self._post("/score/topic-theta", payload)

    def improvement_index(self, student_id: str, window_days: int = 14) -> Dict[str, Any]:
        payload = {"student_id": student_id, "window_days": window_days}
        return self._post("/improvement/index", payload)

    def goal_attainment(self, student_id: str, subject_id: str,
                        target_score: float, target_date: str) -> Dict[str, Any]:
        payload = {"student_id": student_id, "subject_id": subject_id,
                   "target_score": target_score, "target_date": target_date}
    ...
    def report_generate(self, student_id: str, period: str = "weekly") -> Dict[str, Any]:
