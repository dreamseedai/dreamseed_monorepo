  ...
  observeEvent(input$act_low, {
    ...
    if (nrow(students) > 0) {
      if (!(has_role(claims, "teacher") || has_role(claims, "admin"))) {
        ...
        ok <- call_assignment_api(students$student_id, "supplementary_review", claims, assignment_auth)
  ...
  observeEvent(input$act_mid, {
    ...
    if (nrow(students) > 0) {
      if (!(has_role(claims, "teacher") || has_role(claims, "admin"))) {
        ...
        ok <- call_assignment_api(students$student_id, "core_practice", claims, assignment_auth)
  ...
  observeEvent(input$act_high, {
    ...
    if (nrow(students) > 0) {
      if (!(has_role(claims, "teacher") || has_role(claims, "admin"))) {
        ...
        ok <- call_assignment_api(students$student_id, "challenge_advanced", claims, assignment_auth)
  ...
  observeEvent(input$act_very_high, {
    ...
    if (nrow(students) > 0) {
      if (!(has_role(claims, "teacher") || has_role(claims, "admin"))) {
        ...
        ok <- call_assignment_api(students$student_id, "enrichment_extension", claims, assignment_auth)
