...
from app.middleware.policy_routes import (
    route_to_action,
    get_all_actions,
    get_routes_for_action,
...
def test_classes():
    ...
    for method, path, expected_action, expected_flag, expected_approval in cases:
        ...
        ), f"❌ {method} {path}: {action} != {expected_action}"
