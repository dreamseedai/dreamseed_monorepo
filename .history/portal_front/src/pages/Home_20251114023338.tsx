          ...
          <div className="relative overflow-hidden rounded-2xl shadow-xl">
            ...
            <div className="relative bg-slate-900/85 text-white px-6 py-12 text-center backdrop-blur">
              ...
              <div className="flex items-center justify-center gap-3 flex-wrap">
                <a href="/pricing" className="inline-block bg-purple-600 hover:bg-purple-500 text-white px-6 py-3 rounded-full transition focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-purple-400">💳 구독 ($10/월)</a>
