...
export function QuestionForm({ initial, onSubmit, disabled }: { initial?: QuestionInput; onSubmit: (q: QuestionInput) => void; disabled?: boolean }) {
  const [form, setForm] = useState<ExtendedForm>(initial || { stem: "", options: ["", ""], answer: 0, difficulty: "medium", topic: "", tags: [], status: "draft", topic_id: undefined, hint: "", resource: "", answer_text: "" } as any);
