...
class TestMixedEffects:
    ...
    def test_basic_estimation(self):
        """기본 능력 추정 테스트"""
        responses = [
            {"student_id": "s1", "item_id": "q1", "correct": True, "a": 1.0, "b": 0.0, "c": 0.0},
            {"student_id": "s1", "item_id": "q2", "correct": False, "a": 1.0, "b": 1.0, "c": 0.0},
            {"student_id": "s2", "item_id": "q1", "correct": True, "a": 1.0, "b": 0.0, "c": 0.0},
            {"student_id": "s2", "item_id": "q2", "correct": True, "a": 1.0, "b": 1.0, "c": 0.0},
        ]
    ...
    def test_ability_bounds(self):
        ...
        responses = [
            {"student_id": "s1", "item_id": "q1", "correct": True, "a": 1.0, "b": 0.0, "c": 0.0},
            {"student_id": "s1", "item_id": "q2", "correct": True, "a": 1.0, "b": 0.5, "c": 0.0},
            {"student_id": "s1", "item_id": "q3", "correct": True, "a": 1.0, "b": 1.0, "c": 0.0},
        ]
    ...
    def test_difficulty_bias_correction(self):
        ...
        responses = [
            {"student_id": "s1", "item_id": "q1", "correct": True, "a": 1.0, "b": 0.0, "c": 0.0},
            {"student_id": "s1", "item_id": "q2", "correct": False, "a": 1.0, "b": 0.0, "c": 0.0},
            {"student_id": "s2", "item_id": "q1", "correct": True, "a": 1.0, "b": 0.0, "c": 0.0},
            {"student_id": "s2", "item_id": "q2", "correct": False, "a": 1.0, "b": 0.0, "c": 0.0},
            {"student_id": "s3", "item_id": "q1", "correct": True, "a": 1.0, "b": 0.0, "c": 0.0},
            {"student_id": "s3", "item_id": "q2", "correct": False, "a": 1.0, "b": 0.0, "c": 0.0},
        ]
        ...
        theta_std = (sum((t - sum(thetas)/len(thetas))**2 for t in thetas) / len(thetas)) ** 0.5
    ...
    def test_single_student_calibration(self):
        ...
        new_student_responses = [
            {"student_id": "s3", "item_id": "q1", "correct": True, "a": 1.0, "b": 0.0, "c": 0.0},
            {"student_id": "s3", "item_id": "q2", "correct": True, "a": 1.0, "b": 1.0, "c": 0.0},
        ]
    ...
    def test_convergence(self):
        """EM 알고리즘 수렴 테스트"""
        responses = [
            {"student_id": f"s{i}", "item_id": "q1", "correct": i % 2 == 0, "a": 1.0, "b": 0.0, "c": 0.0}
            for i in range(10)
        ] + [
            {"student_id": f"s{i}", "item_id": "q2", "correct": i % 3 == 0, "a": 1.0, "b": 0.5, "c": 0.0}
            for i in range(10)
        ]
