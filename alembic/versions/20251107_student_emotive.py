...
def upgrade():
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('tenant_id', 'student_id', 'day', name='uq_mood_tenant_student_day')
    )
    op.create_index('ix_mood_tenant_student_day', 'student_mood', ['tenant_id', 'student_id', 'day'])
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()')),
        sa.UniqueConstraint('tenant_id', 'student_id', 'day', name='uq_log_tenant_student_day')
    )
    op.create_index('ix_log_tenant_student_day', 'student_daily_log', ['tenant_id', 'student_id', 'day'])
    ...
    op.create_index('ix_goal_tenant_student_created', 'student_goal', ['tenant_id', 'student_id', 'created_at'])
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()')),
        sa.UniqueConstraint('tenant_id', 'student_id', 'day', name='uq_msg_tenant_student_day')
    )
    op.create_index('ix_msg_tenant_student_day', 'student_ai_message', ['tenant_id', 'student_id', 'day'])


def downgrade():
    for table_name in ['student_ai_message', 'student_goal', 'student_daily_log', 'student_mood']:
