#!/usr/bin/env python3
"""
Simple working parser for mpcstudy.com MySQL dump
This parser handles the actual format found in the dump file
"""
...
if __name__ == "__main__":
    ...
    parser = SimpleWorkingParser(dump_file)
