...
class QuickStartRequest(BaseModel):
    ...
    tutor_name: str = Field(
        ..., min_length=1, max_length=100, description="Tutor or school name"
    )
    subject: str = Field(default="Math", description="Subject: Math, English, Science")
    grade_level: str = Field(
        default="G10", description="Grade level: G9, G10, G11, G12"
    )
    num_questions: int = Field(
        default=10, ge=5, le=25, description="Number of questions (5-25)"
    )
