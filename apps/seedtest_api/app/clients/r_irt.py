...
class RIrtClient:
    ...
    async def calibrate(self, observations: List[Dict[str, Any]], model: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def score(self, item_params: Dict[str, Any], responses: List[Dict[str, Any]]) -> Dict[str, Any]:
