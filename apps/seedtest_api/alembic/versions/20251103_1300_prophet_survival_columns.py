...
def upgrade() -> None:
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            sa.Text(),
            nullable=True,
            comment="User ID if this is a per-user model (NULL for global)",
        ),
    )
    op.add_column(
        "prophet_fit_meta",
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Number of weeks used for lookback",
        ),
    )
    op.add_column(
        "prophet_fit_meta",
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Forecast horizon in weeks",
        ),
    )
    op.add_column(
        "prophet_fit_meta",
        sa.Column(
            ...
            sa.Float(),
            nullable=True,
            comment="Anomaly detection threshold used",
        ),
    )
