...
def upgrade():
    ...
    if _table_exists('class_summary'):
        ...
        try:
            op.drop_constraint('ix_class_summary_classroom_week', 'class_summary', type_='unique')
        except Exception:
    ...
    if not _table_exists('risk_threshold'):
        ...
        op.create_index('ix_risk_threshold_updated_at', 'risk_threshold', ['updated_at'])
        op.create_index('ix_risk_threshold_tenant_type', 'risk_threshold', ['tenant_id', 'type'])
...
def downgrade():
    ...
    if _table_exists('class_summary'):
        try:
            op.drop_constraint('uq_class_summary_tenant_classroom_week', 'class_summary', type_='unique')
        except Exception:
            pass
