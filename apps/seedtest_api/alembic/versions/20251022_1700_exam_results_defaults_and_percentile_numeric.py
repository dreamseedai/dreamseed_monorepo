...
def upgrade() -> None:
    ...
    op.execute("ALTER TABLE exam_results ALTER COLUMN percentile TYPE numeric USING percentile::numeric")
...
def downgrade() -> None:
    ...
    op.execute("ALTER TABLE exam_results ALTER COLUMN percentile TYPE integer USING percentile::integer")
