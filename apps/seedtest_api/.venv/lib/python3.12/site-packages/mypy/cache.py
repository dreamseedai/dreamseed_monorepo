...
try:
    from native_internal import Buffer as Buffer
    from native_internal import read_bool as read_bool
    from native_internal import read_float as read_float
    from native_internal import read_int as read_int
    from native_internal import read_str as read_str
    from native_internal import read_tag as read_tag
    from native_internal import write_bool as write_bool
    from native_internal import write_float as write_float
    from native_internal import write_int as write_int
    from native_internal import write_str as write_str
    from native_internal import write_tag as write_tag
except ImportError:
...
def write_literal(
    data: Buffer, value: int | str | bool | float | complex | None
) -> None:
