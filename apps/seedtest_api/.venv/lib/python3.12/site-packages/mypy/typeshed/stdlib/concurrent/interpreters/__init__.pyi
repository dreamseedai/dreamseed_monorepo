...
if sys.version_info >= (3, 13):  # needed to satisfy pyright checks for Python <3.13
    from _interpreters import InterpreterError as InterpreterError
    from _interpreters import InterpreterNotFoundError as InterpreterNotFoundError
    from _interpreters import NotShareableError as NotShareableError
    from _interpreters import (
        _SharedDict,
        _Whence,
    )
    from _interpreters import is_shareable as is_shareable
