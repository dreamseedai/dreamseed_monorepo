...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_users_profile_user_id'), 'users_profile', ['user_id'], unique=True)
    ...
    op.create_index(op.f('ix_attempts_content_id'), 'attempts', ['content_id'], unique=False)
