#!/usr/bin/env python3
"""
Working Data Extractor for DreamSeedAI
=====================================

This script extracts problem data from the mpcstudy.com MySQL dump file
using the correct INSERT statement pattern found in the dump.
"""
...
class WorkingMySQLDumpParser:
    """Working MySQL dump parser for problem data extraction"""
    ...
    def extract_problems(self) -> List[ProblemData]:
        """Extract problem data from MySQL dump with working pattern"""
        ...
        try:
            ...
            # Find the specific INSERT statement pattern we found
            # Pattern: INSERT INTO `tbl_question` VALUES (row1),(row2),...;
...
def main():
    ...
    parser = WorkingMySQLDumpParser(dump_file_path)
    ...
    if problems:
        ...
        parser.save_to_csv('/tmp/mpcstudy_problems_working.csv')
