    ...
    <div className="space-y-1">
      ...
      <Editor
        ...
        onInit={(evt: any, editor: any) => {
          ...
          // Trigger autoresize after init (TinyMCE 4 sometimes needs this)
          if (autoHeight) {
            setTimeout(() => {
        ...
        onEditorChange={(newValue: any) => {
          ...
          // Trigger autoresize on content change
        ...
        init={{
          ...
          content_style: `
            ...
            ${isDark ? `
              ...
              /* Dark mode - WIRIS 수식 이미지 반전 (검은색→흰색) */
              img.Wirisformula,
              img[role="math"],
              ...
              /* Dark mode - 수식 텍스트 밝게 */
              .mce-content-body math mi,
              .mce-content-body math mo,
              .mce-content-body math mn,
              .mce-content-body math mtext {
                color: #e5e7eb !important;
              }
              
              .mce-content-body .katex .katex-html {
                color: #e5e7eb !important;
              }
            ` : `
              /* Light mode */
              ...
              /* Light mode - WIRIS 수식 이미지 필터 없음 (원본 검은색 유지) */
              img.Wirisformula,
              img[role="math"],
              img[src^="data:image/svg+xml"] {
            ...
            .mce-content-body .ds-math:hover {
              ${isDark ? `
          ...
          theme: 'modern',
            ...
            setup: (editor: any) => {
              // Dark mode observer - iframe에 dark 클래스 동기화
              editor.on('init', () => {
                const syncDarkMode = () => {
          ...
          ...(autoHeight ? {
            ...
            autoresize_max_height: maxHeight || 800,
