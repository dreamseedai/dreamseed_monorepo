...
_ROUTE_RULES = [
    ...
    ("GET", re.compile(r"^/api/v1/classes/\d+/risk/summary$"), "risk:read", "risk_engine", None),
    ...
    # Assignments (과제)
    # ========================================================================
    ("POST", re.compile(r"^/api/v1/assignments$"), "assignment:create", None, "content.newitem"),
    ...
    ("PATCH", re.compile(r"^/api/v1/assignments/\d+$"), "assignment:update", None, None),
    ("DELETE", re.compile(r"^/api/v1/assignments/\d+$"), "assignment:delete", None, None),
    
    # ========================================================================
    # Assignment Templates (과제 템플릿)
    # ========================================================================
    ("GET", re.compile(r"^/api/v1/assignment-templates$"), "assignment:template:read", None, None),
    ("GET", re.compile(r"^/api/v1/assignment-templates/\d+$"), "assignment:template:read", None, None),
    ...
    # Risk Engine (위험도 분석)
    # ========================================================================
    ("GET", re.compile(r"^/api/v1/risk/students/\d+$"), "risk:read", "risk_engine", None),
    ("POST", re.compile(r"^/api/v1/risk/analyze$"), "risk:write", "risk_engine", None),
    
    # ========================================================================
    # Content (콘텐츠 제안/승인)
    # ========================================================================
    ("POST", re.compile(r"^/api/v1/content/propose$"), "content:propose", None, "ai_content_recommendation"),
    ...
    # ========================================================================
    ("GET", re.compile(r"^/api/v1/parent/children$"), "own_children:read", "parent_portal", None),
    ("GET", re.compile(r"^/api/v1/parent/children/\d+$"), "own_children:read", "parent_portal", None),
    ("POST", re.compile(r"^/api/v1/parent/consent$"), "consent:manage", "parent_portal", None),
    ("POST", re.compile(r"^/api/v1/parent/data-deletion$"), "data_deletion:request", "parent_portal", "data_deletion_request"),
